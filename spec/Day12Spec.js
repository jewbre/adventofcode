describe("Day 12", function () {
    const digitalPlumber = require('../src/day-12/DigitalPlumber');

    it("when deafult should be 6", function () {
        expect(digitalPlumber('0 <-> 2\n' +
            '1 <-> 1\n' +
            '2 <-> 0, 3, 4\n' +
            '3 <-> 2, 4\n' +
            '4 <-> 2, 3, 6\n' +
    ...
    it("when puzzle should be 141", function () {
        expect(digitalPlumber('0 <-> 82\n' +
            '1 <-> 41, 1402\n' +
            '2 <-> 454, 1690\n' +
            '3 <-> 533, 1726\n' +
            '4 <-> 82\n' +
